...
this contribution of different parameters make it is necessary to decide the combination of these parameters precisely because these parameters affect the performance of PSO.
\section*{Theory}
