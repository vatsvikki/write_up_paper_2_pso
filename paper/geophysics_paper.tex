...
\cite{Kaplanvural2020} The research contributes to the literature by demonstrating the ability of PSO to invert common-offset GPR traces and estimate dielectric properties, including conductivity and relative magnetic permeability, \cite{Fernandez-Martinez2010} used PSO for reservoir characterization, \cite{Fern2010} PSO algorithm's application to the SP inverse problem. An extensively work to find a better global optimization method is also worked
\\
