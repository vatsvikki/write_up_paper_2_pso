...
\par
Since the formulaisation of the FWI it have been gone through a long journey of developemnts to deal with challenges assiciated with the nonlinearity such as multiscale strategy \citep{Bunks1995a, Ravaut2004, Schafer2014, Sirgue2004} focusing on low frequency data for initial inversions and gradually increase to the high frequencies, normalized cross-correlation objective function \citep{ Chi2015, Liu2017} focus on matching of phases to mitigate the effect of amplitudes, envelope-based objective function \citep{Borisov2018, Chi2014} for updating long-wavelength models, and most recent optimal transport function \citep{Brossier2016, Metivier2016, Metivier2018} increases the convexity of the basin of attraction which increase the chance of falling the initial model in the basin of attraction of global minima. 
\par
