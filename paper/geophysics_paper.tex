...
\end{itemize}
\(w\), \(c_1\), \(c_2\), and population size of swarm are the controlling parameters decide the updates. this make it is neccesar to decide the values of these parameters precisecly such that a good cnvergence and effiecint optimised values of variables can be obtained within the computationally feasible iterations.
\section*{Theory}
