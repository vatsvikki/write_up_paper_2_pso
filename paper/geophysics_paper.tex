...
FWI is most efficient seismic data inversion method \citep{Schuster} due to its ability to use all the seismic phases present in the seismic data. This involves the synthetic and observed data comparison in basis of the difference between them initial model is updated until the synthetic data corresponding to the updated model satisfy the stopping criteria. 
\\
